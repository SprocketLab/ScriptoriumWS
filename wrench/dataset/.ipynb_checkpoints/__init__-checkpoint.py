...
def load_dataset(data_home, dataset, dataset_type=None, use_codexLF=False, pt_type=None, extract_feature=False, extract_fn=None, **kwargs):
    ...
    train_data = dataset_class(path=dataset_path, split='train', use_codexLF=use_codexLF, pt_type=pt_type)
    valid_data = dataset_class(path=dataset_path, split='valid', use_codexLF=use_codexLF, pt_type=pt_type)
    test_data = dataset_class(path=dataset_path, split='test', use_codexLF=use_codexLF, pt_type=pt_type)
